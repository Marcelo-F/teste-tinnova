...
public class Veiculo {
  ...
  /**
   * Default constructor
   * @deprecated Use {@link Veiculo#Veiculo(String, String, Integer)}
   */
  @Deprecated
  public Veiculo() {
    super();
   ...
   */
  public Veiculo(String veiculo, String marca, Integer ano) {
    this.veiculo = veiculo;
    this.marca = marca;
    this.ano = ano;
  }

  public Veiculo veiculo(String veiculo) {
    this.veiculo = veiculo;
    return this;
  }
  ...
  */
  ...
  public Veiculo descricao(String descricao) {
  ...
  */
  ...
  public Veiculo vendido(Boolean vendido) {
  ...
  */
  ...
  public Veiculo created(OffsetDateTime created) {
  ...
  */
  ...
  public Veiculo update(OffsetDateTime update) {
    this.update = update;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.veiculo, veiculo.veiculo) &&
        Objects.equals(this.marca, veiculo.marca) &&
        Objects.equals(this.cor, veiculo.cor) &&
        Objects.equals(this.ano, veiculo.ano) &&
        Objects.equals(this.descricao, veiculo.descricao) &&
        Objects.equals(this.vendido, veiculo.vendido) &&
        Objects.equals(this.created, veiculo.created) &&
        Objects.equals(this.update, veiculo.update);
  }

  @Override
  public int hashCode() {
    return Objects.hash(veiculo, marca, cor, ano, descricao, vendido, created, update);
  }
